...
public class WinkDemo {
	...
	public static void main (final String[] args) 
		throws IOException 
	{
		System.out.println ("******************************* wetfeet.wink STARTED ... *************************************\n");

		// set up the resource URI 
		Properties properties = new Properties ();
		properties.load (WinkDemo.class.getClassLoader ().getResourceAsStream ("wink.properties") );
	 ...
	 * @throws IOException if an IO operation fails
	 */
	private static void printResponse (final HttpResponse response) throws IOException {
